...
function createFooter() {
    ...
    footer.innerHTML = `
        <img src="favicon.ico" alt="duomoyu" style="height:1em;width:1em;vertical-align:middle;margin-right:6px;">© duomoyu | 
        Credit: built upon <a href="https://github.com/aldenhallak/fishes" target="_blank" rel="noopener">DrawAFish</a> by <a href="https://fifteen.games" target="_blank" rel="noopener">fifteen.games</a> | 
...
function createSpecialFooter() {
    ...
    footer.innerHTML = `
        ...
        <br><br>
        <img src="favicon.ico" alt="duomoyu" style="height:1em;width:1em;vertical-align:middle;margin-right:6px;">© duomoyu | Credit: built upon <a href="https://github.com/aldenhallak/fishes" style="color: #0066cc; text-decoration: underline;" target="_blank" rel="noopener">DrawAFish</a> by <a href="https://fifteen.games" style="color: #0066cc; text-decoration: underline;" target="_blank" rel="noopener">fifteen.games</a> | 
